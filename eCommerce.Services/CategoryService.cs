...
using eCommerce.Model.Extensions;
    ...
    ICategoryService
{
    ...
    public CategoryService(MapsterMapper.IMapper mapper, IValidator<CategoriesInsertRequest> insertValidator,
        IValidator<CategoriesUpdateRequest> updateValidator) : base(mapper, insertValidator, updateValidator)
    {
    }
    ...
    {
        if (request.Name.Length < 3) throw new ClinetException("Category name must be at least 3 characters long.");
